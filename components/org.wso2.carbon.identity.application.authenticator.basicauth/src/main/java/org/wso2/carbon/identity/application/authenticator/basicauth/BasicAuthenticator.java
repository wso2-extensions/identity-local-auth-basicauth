...
public class BasicAuthenticator extends AbstractApplicationAuthenticator
    ...
    protected void initiateAuthenticationRequest(HttpServletRequest request,
        ...
        String loginPage = IdentityUtil.resolveURL(configurationFacade.getAuthenticationEndpointURL(), false, false);
        String retryPage = IdentityUtil.resolveURL(configurationFacade.getAuthenticationEndpointRetryURL(), false,
                                                  false);
